...
class SiteSettings extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, site_id, about_us, about_us_en, about_us_URL, footer, footer_en', 'required'),
			array('id, site_id', 'numerical', 'integerOnly'=>true),
			array('about_us_URL', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, site_id, about_us, about_us_en, about_us_URL, footer, footer_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('about_us_en',$this->about_us_en,true);
		$criteria->compare('about_us_URL',$this->about_us_URL,true);
		$criteria->compare('footer',$this->footer,true);
		$criteria->compare('footer_en',$this->footer_en,true);
